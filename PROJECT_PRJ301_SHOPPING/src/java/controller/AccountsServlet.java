...
//        String user = a.getUser();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String UserName = request.getParameter("user")+"xyz";
        String Password = request.getParameter("pass");
        String isSellS = request.getParameter("isSell");
        int isSell = Integer.parseInt(isSellS);
        String isAdminS = request.getParameter("isAdmin");
        int isAdmin = Integer.parseInt(isAdminS);
        String Email = request.getParameter("email");
        String msg = "";
        DAO dao = new DAO();
        dao.insertAccount(UserName, Password, isSell, isAdmin, Email);
