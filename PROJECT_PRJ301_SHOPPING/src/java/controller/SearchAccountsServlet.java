 ...
 * @author tungn
 */
@WebServlet(name = "SearchAccountServlet", urlPatterns = {"/searchaccount"})
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        List<Accounts> list = dao.getAccountsBySearchName(txtSearch);

        request.setAttribute("accList", list);
        request.setAttribute("searchValue", txtSearch);

        request.getRequestDispatcher("search_account_ajax.jsp").forward(request, response);
    }
