...
GO
-- Add more customer
INSERT INTO Accounts ( [user], [pass], [isSell], [isAdmin]) VALUES ( N'customer1', N'123456', 0, 0),
( N'customer2', N'123456', 0, 0);
...
INSERT INTO Orders ([uID], [total_price], [address], [receiver_name], [receiver_phone],[status] ,[note])
VALUES
    (5, 9605400, '789 Tran Hung Dao Avenue, Da Nang', 'codewithdt', '+84 79 6428 094', 'Processing', 'Contact recipient before delivery.'),
    (5, 24129000, '888 Nguyen Trai Road, Can Tho', 'codewithdt', '+84 79 6428 094', 'Shipped', 'Delivery instructions included.'),
    (7, 12384400, '222 Ly Thai To Street, Hai Phong', 'codewithdt', '+84 79 6428 094', 'Processing', 'Contact recipient.'),
    (5, 10313000, '333 Vo Van Tan Street, Vung Tau', 'codewithdt', '+84 79 6428 094', 'Delivered', 'Signed by recipient.'),
    (7, 22182000, '444 Nguyen Dinh Chieu Road, Quy Nhon', 'codewithdt', '+84 79 6428 094', 'Processing', 'Call before delivery.'),
    (8, 19153600, '555 Tran Phu Street, Phu Quoc', 'codewithdt', '+84 79 6428 094', 'Shipped', 'Handle with care.'),
    (5, 14152000, '666 Dien Bien Phu Street, Buon Ma Thuot', 'codewithdt', '+84 79 6428 094', 'Processing', 'Call recipient on delivery.'),
    (8, 25178600, '777 Nguyen Van Linh Street, Can Gio', 'codewithdt', '+84 79 6428 094', 'Delivered', 'Left at gate.'),
    (5, 16958600, '111 Vo Thi Sau Avenue, Vung Tau', 'codewithdt', '+84 79 6428 094', 'Processing', 'Delivery expected today.'),
    (7, 14768700, '222 Ton Duc Thang Road, Ha Long', 'codewithdt', '+84 79 6428 094', 'Shipped', 'Contact recipient.'),
    (8, 8417000, '333 Le Duan Street, Rach Gia', 'codewithdt', '+84 79 6428 094', 'Processing', 'Leave at front desk.'),
    (7, 7485000, '444 Tran Quoc Toan Boulevard, Tam Ky', 'codewithdt', '+84 79 6428 094', 'Delivered', 'Signed by security.'),
    (5, 8604000, '555 Truong Sa Street, Con Dao', 'codewithdt', '+84 79 6428 094', 'Processing', 'Handle with care.'),
    (8, 8385000, '666 Nguyen Trai Avenue, Soc Trang', 'codewithdt', '+84 79 6428 094', 'Shipped', 'Delivery instructions included.'),
    (7, 5649000, '777 Tran Hung Dao Street, Long Xuyen', 'codewithdt', '+84 79 6428 094', 'Processing', 'Call recipient.'),
    (5, 9170400, '888 Ly Thuong Kiet Road, Dong Hoi', 'codewithdt', '+84 79 6428 094', 'Delivered', 'Left at front door.');
GO
-- Insert into the Order_details
INSERT INTO Order_details ([pid], [oid], [quantity], [price])
VALUES
    (2, 1, 2, 1450000),  
    (3, 1, 1, 1715400),   
    (6, 1, 2, 2495000),    
    
    -- 1450000*2+1715400+2495000*2=9605400/

    (4, 2, 1, 2495000),   
    (5, 2, 3, 2495000),    
    (12, 2, 1, 2749000),   
    (16, 2, 3, 3800000),   
    -- 2495000+2495000*3+2749000+38000002*3=24129000/

    (6, 3, 2, 2495000),    
    (7, 3, 1, 2495000), 
    (20, 3, 2, 1400000),    
    (24, 3, 1, 2099400),
    -- 2495000*2+2495000+1400000*2+2099400=12384400/

    (8, 4, 2, 1119000),    
    (9, 4, 1, 2795000), 
    (7, 4, 3, 2495000),   
    (10, 4, 1, 2795000),   
    -- 1119000*2+2795000+2495000*3+2795000=10313000/

    (10, 5, 1, 2795000),   
    (11, 5, 2, 4519000), 
    (23, 5, 1, 2749000),   
	(26, 5, 2, 3800000),  
    -- 2795000+4519000*2+2749000+3800000*2=22182000/

    (12, 6, 1, 2749000),  
    (13, 6, 3, 2749000),   
    (27, 6, 3, 1859400),    
    (30, 6, 1, 2579400),    
    -- 2749000+2749000*3+1859400*3+2579400=19153600/

    (14, 7, 2, 2919000),   
    (15, 7, 1, 2919000),   
    (2, 7, 2, 1450000),    
    (4, 7, 1, 2495000),  
    -- 2919000*2+2919000+1450000*2+2495000=14152000/

    (16, 8, 3, 3800000),   
    (17, 8, 2, 3600000),    
    (18, 8, 1, 2240000),    
    (23, 8, 2, 2169300),    
    -- 3800000*3+3600000*2+2240000+2169300=25178600/

    (18, 9, 1, 2240000),    
    (19, 9, 2, 3150000),   
    (16, 9, 1, 3800000),   
    (26, 9, 2, 2309300),   
    -- 2240000+3150000*2+3800000+2309300*2=16958600/

    (20, 10, 3, 1400000),  
    (23, 10, 1, 2169300),  
    (24, 10, 1, 2099400),   
    (19, 10, 2, 3150000),    
    -- 1400000*3+2169300+45000000+3150000*2=14768700/

    (13, 11, 2, 2749000), 
    (14, 11, 1, 2919000),  
    -- 2749000*2+2919000=8417000/

    (5, 12, 1, 2495000),  
    (6, 12, 2, 2495000),  
    -- 2495000+2495000*2=7485000/

    (7, 13, 3, 2495000),  
    (8, 13, 1, 1119000), 
    -- 2495000*3+1119000=8604000/

    (9, 14, 2, 2795000),  
    (10, 14, 1, 2795000),  
    -- 2795000*2+2795000=8385000/

    (1, 15, 1, 2749000), 
    (2, 15, 2, 1450000),  
    -- 2749000+1450000*2=5649000/

    (3, 16, 1, 1715400), 
    (4, 16, 3, 2495000);  
    -- 1715400+2495000*3=9170400
